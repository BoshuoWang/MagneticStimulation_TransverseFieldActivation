...
color_map_per_pos = zeros(255,3);
color_map_per_pos(1:51,1) = linspace(0.5,1,51);
color_map_per_pos(51:end,1) = 1;
color_map_per_pos(51:end,2) = linspace(0,1,205);
color_map_per_pos(51:end,3) = color_map_per_pos(51:end,2);
for ii = 256:-1:256-8
...
color_map_per_full = [color_map_per_neg;flipud(color_map_per_pos)];
...
color_level_amp = amp_log_min_cf:0.01:amp_log_max;
